...
public class PresenceDetection
    ...
    private boolean ping(String host) throws IOException, InterruptedException {
        ...
        //Espera a que el proceso finalice. Si ha terminado devolverá 0:
        int returnVal = proc.waitFor(); 
        
        //Si el valor devuelto es 0 indica la correcta terminación del Proceso hijo y por lo tanto el método devuelve True.
        return returnVal == 0; 
    }
