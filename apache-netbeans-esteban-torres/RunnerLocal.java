...
public class RunnerLocal extends RunnerJava {
   ...
   /**
    ...
    public Result call() {
        ...
        //Aquí se crea el objeto ProcessBuilder.
        ProcessBuilder pb = new ProcessBuilder(args);
        
        //Esta llamada a "redirectErrorStream()" es la que se encarga de conectar el proceso padre
        //a los posibles errores del proceso hijo.
        pb.redirectErrorStream(true);
        
        //Este es el proceso hijo que se devolverá con la invocación
        //a este método ("call()").
        Process process;
        setProcessCurrentDir(pb);
        setJavaEnvironment(pb.environment(), command);
        try {
            //El proceso recibe su valor, es decir; empieza a ejecutarse.
            process = pb.start();
        ...
        //Estamos devolviendo el proceso hijo creado
        //al alterar el parámetro "value" del objeto "result".
