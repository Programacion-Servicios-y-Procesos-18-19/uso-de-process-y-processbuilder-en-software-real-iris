...
//  protected int exitCode = -1;
  ...
  //crea el objeto e inicia el proceso, y envia el comando a ejecucion//
  //__________________________________________________________________//
  public void asynchronousStart() throws IOException {
	...
	//__________________________________________________________________//
	//redirecionamiento del proceso creado junto con el objeto de tipo executionLogListener
	//__________________________________________________________________//
    redirectOutputs(process, executionLogListener);
  }
	//aqui genera los hilos del proceso en entrada de cadenas y entrada de errores
...
//__________________________________________________________________//
// toma el comando escrito y devuelve como una cadena
//__________________________________________________________________//
